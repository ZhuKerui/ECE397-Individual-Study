...
from span_pair2vec.matrix_data import read_data
from span_pair2vec.util import get_args, get_config, makedirs
from span_pair2vec import metrics, util
import numpy
...
def main(args, config):
    ...
    train_data, dev_data, train_iterator, dev_iterator, args_field, rels_field = read_data(config)
