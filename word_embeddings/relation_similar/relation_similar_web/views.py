...
co_occur.load_word_vector('../../../dataset/relation_similar/vecs')
semantic_related.load_word_vector('../../../dataset/relation_similar/vecs')
...
semantic_related.load_pairs('../../../dataset/relation_similar/semantic_related.csv')
...
def search(request):
    ...
    if pair_set == "co_occur":
        ...
        clusters = semantic_related.dbscan_cluster(ck, eps=eps, min_samples=min_samples)
    if clusters is None:
        content['status'] = 0
    else:
        content['status'] = 1
